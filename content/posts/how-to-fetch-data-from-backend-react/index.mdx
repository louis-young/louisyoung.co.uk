...
We'll pass in our endpoint to fetch from, and recieve our loading, error, and data states. Here we're renaming `data` to `tasks` in our destructuring assignment to keep the naming consistant.
