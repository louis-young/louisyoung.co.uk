...
date: "2021-02-14T05:35:07.322Z"
description: "Today, we'll look at how to handle protected routes (also known as private routes) using React Router and the Context API. Protected routes prevent unauthenicated and unauthorised users from acessing certain parts of our application."
...
1. [What are protected routes?](#what-are-protected-routes)
2. [A note about security](#a-note-about-security)
3. [Implementation](#implementation)
   1. [Context](#context)
   2. [Protected route component](#protected-route-component)
   3. [Usage](#usage)
4. [Conclusion](#conclusion)

## What are protected routes?

Protected routes prevent unauthenicated and unauthorised users from acessing certain parts of our application.
...
For the purposes of this tutorial, let's mock this and simply immediately authenticate ourselves.
...
Now, we want to build a component which allows us to interface with it similiarly to how we do with the `Route` component from React Router.
