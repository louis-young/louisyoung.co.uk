...
1. [What is an article progress indicator?](#what-is-an-article-progress-indicator)
2. [Why use an article progress indicator?](#why-use-an-article-progress-indicator)
3. [Tutorial](#tutorial)
   1. [Component and state](#component-and-state)
   2. [Effects](#effects)
   3. [Events](#events)
